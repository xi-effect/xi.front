...
const PasswordReset = inject('authorizationSt')(
                ...
                >
                    ...
                    render={({ field }) => (
                      ...
                      >
                        <InputLabel htmlFor="outlined-adornment-password">
                          {' '}
                          <Typography sx={{ color: 'text.main' }}>Пароль</Typography>{' '}
                        </InputLabel>
                        <Input
                        ...
                        {errors?.password?.message === 'password must be at least 6 characters' && (
                          <Typography variant="subtitle1" sx={{ mt: 1, ml: 1 }} color="error">
                            {' '}
                  ...
                  {authorizationSt.passwordReset.emailResetOk && (
                    <Typography variant="subtitle1">
                      {' '}
                      Пароль успешно сохранён. С этой страницы можно безопасно уходить{' '}
                    </Typography>
                  )}
                </Stack>
              </Box>
