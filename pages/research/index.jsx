...
const Research = () => {
  ...
  const handleFileDelete = (event) => {
    setFilesArray((prevState) =>
      prevState.filter((_, index) => index !== Number(event.target.dataset.id)),
    );
  };
          ...
          >
            ...
            >
              <Stack
                direction="row"
                justifyContent="space-between"
                sx={{ m: '24px 24px 12px 24px' }}
              >
                <Stack direction="row" alignItems="flex-end">
                  <Typography variant="h5">
                    <strong>Решение</strong>
                  </Typography>
                  <Typography variant="subtitle2" color="#999999" sx={{ ml: '5px', mb: '4px' }}>
                    до 14 сен 22
                  </Typography>
                </Stack>
                <Typography
    ...
    <>
      ...
      >
        <Stack direction="row">
          <Stack>
            <TextSnippetOutlined
              sx={{ width: '45px', height: '55px', ml: '15px', color: '#445AFF' }}
            />
          </Stack>
