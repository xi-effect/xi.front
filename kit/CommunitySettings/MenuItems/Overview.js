...
const getColor = () => {
  ...
  switch (color) {
    case 1:
      return blue[Number(`${colorIndex + 1}00`)];
    case 2:
      return teal[Number(`${colorIndex + 1}00`)];
    case 3:
      return green[Number(`${colorIndex + 1}00`)];
    case 4:
      return orange[Number(`${colorIndex + 1}00`)];
    case 5:
      return red[Number(`${colorIndex + 1}00`)];
    case 6:
      return blueGrey[Number(`${colorIndex + 1}00`)];
    case 7:
      return indigo[Number(`${colorIndex + 1}00`)];
    default:
      return green[`${colorIndex + 1}00`];
  }
};
...
const Overview = inject()(
  observer(() => {
    ...
    return (
      ...
      >
        <Typography variant="h5">Обзор Сообщества</Typography>
        <Divider flexItem />
        <Stack
          direction="column"
        ...
        >
          ...
          >
            <Box>
              <Avatar size={128} name="Maria l" variant={avatarType} colors={colors} />
            </Box>
            <Stack
              direction="column"
              justifyContent="flex-start"
            ...
            >
              <Stack direction="row" justifyContent="flex-start" alignItems="center" spacing={2}>
                <Typography variant="h6">Аватар сообщества</Typography>
              ...
              <FormControl variant="filled" sx={{ m: 1, minWidth: 240 }}>
                ...
                <Select value={avatarType} onChange={handleChange}>
