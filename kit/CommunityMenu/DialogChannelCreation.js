...
const content = [
  ...
  },
  {
    label: "Страница",
    description:
      "Создавайте и делитесь контентом. Например, это может быть конспект к уроку",
  ...
  observer((props) => {
    ...
    return (
      ...
      >
        ...
        <Typography
          variant="subtitle2"
          sx={{ color: "text.secondary", pt: 2, pb: 1 }}
        >
          {" "}
          НАЗВАНИЕ{" "}
        </Typography>
...
const DialogChannelCreation = inject(
  "communityChannelsSt",
  "uiSt"
)(
  observer(({ communityChannelsSt, uiSt }) => {
