    ...
    return (
      <Stack direction="column" justifyContent="flex-start" alignItems="flex-start" spacing={3}>
        <Stack direction="row" justifyContent="flex-start" alignItems="center" spacing={0}>
          ...
          {hiddenEmail && (
            <Link
              sx={{ color: 'text.primary', cursor: 'pointer', pl: 1 }}
        ...
        <Stack direction="row" justifyContent="flex-start" alignItems="center" spacing={0}>
          ...
          <DialogChangeEmail
            ...
            setOpenEmailChangeDialog={setOpenEmailChangeDialog}
          />
          <DialogChangePassword
            openPasswordChangeDialog={openPasswordChangeDialog}
            setOpenPasswordChangeDialog={setOpenPasswordChangeDialog}
          />
        </Stack>
      </Stack>
    );
